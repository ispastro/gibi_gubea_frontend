  ...
  const handleSaveAdmin = (adminData: Admin) => {
    if (modalMode === 'add') {
      ...
      const updatedAdmins = admins.map(admin => 
        admin.id === selectedAdmin.id ? { ...adminData, id: admin.id } : admin
      );
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div className="flex space-x-2">
                      ...
                      <button 
                        ...
                        disabled={admin.adminUsername === 'admin'} // Prevent deleting the main admin
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            {modalMode === 'delete' ? (
              <div className="p-6">
                ...
                <p className="mb-6">
                  Are you sure you want to delete admin "{selectedAdmin?.adminUsername}"?
                </p>
